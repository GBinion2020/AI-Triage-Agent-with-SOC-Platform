...
@mcp.tool()
def safe_search_osint(indicator: str, max_results: int = 3) -> dict:
    """
    Run safe, provider-backed OSINT search for a public indicator.
    Internal/private indicators are skipped by policy.
    """
    return osint.safe_search_indicator(indicator=indicator, max_results=max_results)
