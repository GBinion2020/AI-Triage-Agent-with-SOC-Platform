...
from mcp_server.tools import cloudtrail, entra, osint, sandbox, siem, virustotal
...
class ToolExecutor:
    ...
    def execute(self, tool_name: str, args: Dict[str, Any]) -> str:
        ...
        try:
            ...
            elif tool_name == "safe_search_osint":
                raw_result = osint.safe_search_indicator(**args)
            else:
